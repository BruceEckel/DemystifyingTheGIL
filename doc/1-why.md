...
Speed. Performance optimization adds complexity to your system that is wasted time if you don't actually need it.
I've seen needlessly complex systems generated by an architect who was certain there would be a performance problem,
but there was no actual testing, just imagination.
...
If it isn't fast enough, first consider simpler alternatives (use Occam's razor):

- **Profile your system and identify bottleneck functions**. Convert these into Rust modules via PyO3;
